						...
						<div class="flex flex-row gap-4">
							<Show when={props.server.tps}>
								<div class="flex flex-row truncate">
									<img src={tpsImg} class="w-[18px] h-[18px] sm:w-[22px] sm:h-[22px]" alt=""></img>
							...
							<div class="flex flex-row truncate">
								<img src={latencyImg} class="w-[18px] h-[18px] sm:w-[22px] sm:h-[22px]" alt=""></img>
								<h2 class="text-sm sm:px-2 sm:text-lg">{props.server.latency} ms</h2>
							</div>
						</div>
					</div>
				</div>
